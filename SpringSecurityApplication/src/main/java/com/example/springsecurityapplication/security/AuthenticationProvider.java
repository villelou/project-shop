...
//         // Получаем логин с формы аутентификации. За нас Spring Security сам создаст объект формы и передаст и передаст его в объект аутентификации authentication
