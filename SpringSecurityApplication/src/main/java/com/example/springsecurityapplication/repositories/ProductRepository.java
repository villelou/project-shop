...
public interface ProductRepository extends JpaRepository <Product, Integer>{
    ...
    // Поиск по наименованию и фильтрация по диапозону цены, а также сортировка по возрастанию цены
    ...
    // Поиск по наименованию и фильтрация по диапозону цены, а также сортировка по убыванию цены
    ...
    // Поиск по наименованию и фильтрация по диапозону цены, сортировка по возрастанию цены, а также фильтрация по категории
    ...
    // Поиск по наименованию и фильтрация по диапозону цены, сортировка по убыванию цены, а также фильтрация по категории
